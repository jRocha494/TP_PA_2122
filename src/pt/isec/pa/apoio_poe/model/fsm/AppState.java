...
public enum AppState {
    CONFIGURATIONS_STATE_STAGE_ONE, CONFIGURATIONS_STATE_STUDENT_MANAGER,
    CONFIGURATIONS_STATE_TEACHER_MANAGER, CONFIGURATIONS_STATE_PROPOSAL_MANAGER, CLOSED_STAGE, APPLICATION_OPTIONS_STAGE_TWO, PROPOSAL_ATTRIBUTION_STAGE_THREE,
    ...
    public IState createState(AppContext ac, DataLogic dl) {
        return switch (this){
            ...
            case PROPOSAL_ATTRIBUTION_STAGE_THREE -> new StageThree(ac,dl);
